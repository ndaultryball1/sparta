...
CollideStyle(dms/kk,CollideDMSKokkos)

#else

#ifndef SPARTA_COLLIDE_DMS_KOKKOS_H
#define SPARTA_COLLIDE_DMS_KOKKOS_H
...
class CollideDMSKokkos : public CollideDMS {
 public:
  typedef COLLIDE_REDUCE value_type;

  CollideDMSKokkos(class SPARTA *, int, char **);
  ~CollideDMSKokkos();
  void init();
  void reset_vremax();
  void collisions();
